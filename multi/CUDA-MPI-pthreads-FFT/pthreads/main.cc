...
//unsigned _stdcall threaded_dft(const std::vector<std::vector<Complex>> &inputArray, std::vector<std::vector<Complex>> &newArray, int start, int stop, int dim)
//{
